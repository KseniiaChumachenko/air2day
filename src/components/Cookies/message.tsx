...
export const message = (
  <Trans>
    <h1>Privacy Policy for Czech Technical Univercity</h1>

    <p>
      At air2day, accessible from www.air2day.cz, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by air2day and how we use
      it.
    </p>
    ...
    <p>
      ...
      and/or collect in air2day. This policy is not applicable to any
    ...
    <p>
      air2day follows a standard procedure of using log files. These files log
    ...
    <p>
      ...
      advertising partners of air2day.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on air2day, which are sent directly
    ...
    <p>
      Note that air2day has no access to or control over these cookies that are
    ...
    <p>
      air2day's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      air2day does not knowingly collect any Personal Identifiable Information
